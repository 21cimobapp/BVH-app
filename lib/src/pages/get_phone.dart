...
import 'package:civideoconnectadmin/firebase/auth/phone_auth/select_country.dart';
import 'package:civideoconnectadmin/firebase/auth/phone_auth/verify.dart';
...
class _PhoneAuthGetPhoneState extends State<PhoneAuthGetPhone> {
  ...
  void initState() {
    ...
    } else if (globals.loginUserType == "ADMIN") {
      appName = "Admin Login";
    }
  }
  ...
  Future<int> checkMobileExists() async {
    ...
    if (globals.loginUserType == "DOCTOR") {
      ...
      url = "${globals.apiHostingURL}/Doctors/mapp_CheckMobileExistsAdmin";
    } else {
